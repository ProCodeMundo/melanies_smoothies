...
#Adding a Name Box for Smoothie Orders
...
#Creating a variable to store the Ingridients data
    ingredients_string = ''
#Creating a for loop to convert the List to a String 
    
    #Means: For each fruit_chosen in ingredients_list
